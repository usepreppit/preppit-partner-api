...
import { AdminRepository } from '../../application/users/models/admin.repository';
import { PartnerRepository } from '../../application/users/models/partner.repository';
...
container.bind<AdminRepository>(AdminRepository).toSelf();
container.bind<PartnerRepository>(PartnerRepository).toSelf();
...
container.bind<typeof AdminModel>('AdminModel').toConstantValue(AdminModel); 
container.bind<typeof PartnerModel>('PartnerModel').toConstantValue(PartnerModel);
